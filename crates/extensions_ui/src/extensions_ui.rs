        ...
        for feature in &self.upsells {
            let banner = match feature {
                Feature::AgentClaude => self.render_feature_upsell_banner(
                    "Claude Agent support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::AgentCodex => self.render_feature_upsell_banner(
                    "Codex CLI support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::AgentGemini => self.render_feature_upsell_banner(
                    "Gemini CLI support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionBasedpyright => self.render_feature_upsell_banner(
                    "Basedpyright (Python language server) support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionRuff => self.render_feature_upsell_banner(
                    "Ruff (linter for Python) support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionTailwind => self.render_feature_upsell_banner(
                    "Tailwind CSS support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionTy => self.render_feature_upsell_banner(
                    "Ty (Python language server) support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::Git => self.render_feature_upsell_banner(
                    "noah comes with basic Git support—more features are coming in the future."
                        .into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ...
                Feature::LanguageBash => self.render_feature_upsell_banner(
                    "Shell support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
                Feature::LanguageC => self.render_feature_upsell_banner(
                    "C support is built into noah.".into(),
                    "https://noah.asherin.com/faq".into(),
                    false,
                    cx,
                ),
