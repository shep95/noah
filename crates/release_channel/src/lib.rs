...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Noah-Editor-Dev",
        ReleaseChannel::Nightly => "Noah-Editor-Nightly",
        ReleaseChannel::Preview => "Noah-Editor-Preview",
        ReleaseChannel::Stable => "Noah-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "noah Dev",
            ReleaseChannel::Nightly => "noah Nightly",
            ReleaseChannel::Preview => "noah Preview",
            ReleaseChannel::Stable => "noah",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "com.asherin.noah-Dev",
            ReleaseChannel::Nightly => "com.asherin.noah-Nightly",
            ReleaseChannel::Preview => "com.asherin.noah-Preview",
            ReleaseChannel::Stable => "com.asherin.noah",
        }
    }
