...
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions only apply to shepherd, the native agent, and don’t extend to external agents connected through the Agent Client Protocol (ACP).";
