    ...
    fn security_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "When opening noah, avoid Restricted Mode by auto-trusting all projects, enabling use of all features without having to give permission to each new project.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn workspace_restoration_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "What to restore from the previous session when opening noah.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn privacy_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data to Zed's telemetry service. Off by default in noah.",
                field: Box::new(SettingField {
                    organization_override: None,
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    files: USER,
                    title: "Icon Theme",
                    description: "The custom set of icons noah will associate with files and directories.",
                    field: Box::new(SettingField {
                        organization_override: None,
    ...
    fn file_scan_section() -> [SettingsPageItem; 7] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be excluded by noah entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                field: Box::new(
                    SettingField {
                        organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be included by noah, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down Zed's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                field: Box::new(
                    SettingField {
                        organization_override: None,
    ...
    fn window_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "(Linux only) whether noah or your compositor should draw window decorations.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether breakpoints should be reused across noah sessions.",
                field: Box::new(SettingField {
                    organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to log messages between active debug adapters and noah.",
                field: Box::new(SettingField {
                    organization_override: None,
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    description: "Disable all Git integration features in noah.",
                    field: Box::new(SettingField::<bool> {
                        organization_override: None,
...
fn ai_page(cx: &App) -> SettingsPage {
    fn general_section() -> [SettingsPageItem; 8] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Disable AI",
                description: "Whether to disable all AI features in noah.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn agent_configuration_section(_cx: &App) -> Box<[SettingsPageItem]> {
        ...
        items.extend([
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Command to automatically run when noah creates a Terminal Thread shell in the agent panel. Runs in your configured shell.",
                field: Box::new(SettingField {
                    organization_override: None,
...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn autoclose_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Use Autoclose",
                description: "Whether to automatically type closing characters for you. For example, when you type '(', noah will automatically add a closing ')' at the correct position.",
                field: Box::new(SettingField {
                    organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', noah will automatically surround text with ().",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn tasks_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Prefer LSP",
                description: "Use LSP tasks over noah language extension tasks.",
                field: Box::new(SettingField {
                    organization_override: None,
